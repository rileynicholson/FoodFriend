...
FoodFriend! is a Java program that helps a user come up with recipes to make with ingredients they have in their pantry. FoodFriend gives ideas ranging from something as small as a snack to as big as a main course meal.
...
- **Java Development Kit:** I used Java 25 to make this project.
...
2. Open Eclipse.
3. Navigate to File in the top right corner, then Import.
...
# Future Improvements to FoodFriend!
